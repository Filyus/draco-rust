//! Valence-based EdgeBreaker traversal encoder.
//!
//! Encode-side counterpart of the valence traversal decoder: orders and codes
//! EdgeBreaker symbols using per-vertex valence context for better compression.
//! Port of Draco's `mesh_edgebreaker_traversal_valence_encoder.h`.

...
The round-by-round record behind the figures in
[`PERFORMANCE.md`](PERFORMANCE.md): what was tried, what it measured, and
whether it was kept. Everything that did not work is here on purpose. A round
that measured to nothing is the most expensive kind of result to reproduce by
accident, so it is written down at the same length as one that landed.

**Read the index before starting an optimization round.** If the idea already
appears there as `null` or `rejected`, the question is not whether to try it
but whether anything has changed since -- the round says what was measured and
against which reference, which is what makes that answerable.

Three documents divide the work:

- [`PERFORMANCE.md`](PERFORMANCE.md) -- what is true now, and the harnesses
  that measure it.
- [`TRICKS.md`](TRICKS.md) -- the patterns worth reusing, stated so they
  transfer to another codebase.
- this file -- the specific attempts, with their numbers and their verdicts.

A round graduates into `TRICKS.md` when it produced a pattern that generalizes;
it stays here either way. Landing a headline figure in `PERFORMANCE.md` does
not remove the round from this log.

**Figures here are pinned to the moment they were taken.** Each round names its
reference build, its machine and usually its commit, and it is not updated
afterwards -- a round is a record of an experiment, not a gauge of current
state. Sections whose C++ side is the patched checkout described in
`PERFORMANCE.md` are marked as such and cannot be compared with a pristine-build
figure at all.

## Verdicts

`landed` -- kept, measured to help. `null` -- measured, effect not resolvable.
...
| --- | --- | ---: |
| [Against The 2026-07-31 Figures](#against-the-2026-07-31-figures) | retracted | `7-18%` |
| [What The 2.0 Optimization Series Changed](#what-the-20-optimization-series-changed) | retracted | `11%` |
| [The 2026-08-18 Round, Including What Did Not Work](#the-2026-08-18-round-including-what-did-not-work) | landed | `8.7%` |
| [The Corner-Table Access Refactor](#the-corner-table-access-refactor) | landed | `4-5%` |
| [Round Two: A Traversal Nobody Read](#round-two-a-traversal-nobody-read) | landed | `11-13%` |
| [Round Three: The Same Table, Checked Twice](#round-three-the-same-table-checked-twice) | landed | `1.8-2.1%` |
| [Round Four: The Allocator, Not The Bytes](#round-four-the-allocator-not-the-bytes) | diagnostic | `20-30%` |
| [Source-Level Follow-Up: Audited, Not A Win](#source-level-follow-up-audited-not-a-win) | null | `12 sites, 0 fixed` |
| [Round Five: The Table Nobody Reserved](#round-five-the-table-nobody-reserved) | landed | `3.0-3.4%` |
| [Round Six: A Corner Nobody Wanted](#round-six-a-corner-nobody-wanted) | landed | `2.5%` |
| [A Source-Level Follow-Up, Audited -- Not A Win](#a-source-level-follow-up-audited-not-a-win) | null | `0.0-0.4%` |
| [The Same Fusion, Two More Predictors](#the-same-fusion-two-more-predictors) | null | -- |
| [The Same Bug, A Smaller Table](#the-same-bug-a-smaller-table) | null | `77 -> 65 allocations` |
| [The Traversal Nobody Thought Was The Default](#the-traversal-nobody-thought-was-the-default) | landed | `0.5-0.8%` |
| [The Encoder's Turn: Dead State And Unreserved Symbols](#the-encoders-turn-dead-state-and-unreserved-symbols) | landed | `6.1-6.5%` |
| [What The Encoder Actually Spends Its Time On](#what-the-encoder-actually-spends-its-time-on) | null | `+0.05%` |
| [The Biggest Stage Is Not The Gap](#the-biggest-stage-is-not-the-gap) | diagnostic | `1.2x` |
| [The Sweep For What The Lint Cannot See](#the-sweep-for-what-the-lint-cannot-see) | landed | `139 KB` |
| [And The Whole Encode, Against A Reference Pinned On Purpose](#and-the-whole-encode-against-a-reference-pinned-on-purpose) | retracted | `0.90x -> 1.05-1.38x` |
| [Splitting The Other Half, And Where The Sweep's Gap Actually Was](#splitting-the-other-half-and-where-the-sweeps-gap-actually-was) | landed | `12.2-12.8%` |
| [The Fan's Quadratic Stage Was Not The One Predicted](#the-fans-quadratic-stage-was-not-the-one-predicted) | landed | `15,679 -> 886 us` |
| [The Restart Upstream's TODO Points At, Tried And Rejected](#the-restart-upstreams-todo-points-at-tried-and-rejected) | rejected | `3 sweeps` |
| [One Run For The Whole Matrix](#one-run-for-the-whole-matrix) | retracted | `0.90x -> 0.98-1.04x` |
| [The Diagnostic Pass, Run Once For Everything](#the-diagnostic-pass-run-once-for-everything) | diagnostic | `19,541 allocations per encode` |
| [One Allocation Per Vertex, On The One Family That Was Behind](#one-allocation-per-vertex-on-the-one-family-that-was-behind) | landed | `-14 to -16%` |
| [Four Bools On The Heap, Once Per Vertex](#four-bools-on-the-heap-once-per-vertex) | landed | `-6.6 to -13.8%` |
| [The Ring Walked Twice, And A Ceiling Estimated Wrong](#the-ring-walked-twice-and-a-ceiling-estimated-wrong) | landed | `-13.2%` |
| [The Surplus Was Mine, And Splitting The Counter Found It](#the-surplus-was-mine-and-splitting-the-counter-found-it) | landed | `45,314 loads removed` |
| [The Fold, Sized First And Rewritten Twice](#the-fold-sized-first-and-rewritten-twice) | landed | `-12%` |
| [Decode, Re-Taken Against A Pinned Reference -- And It Is Behind](#decode-re-taken-against-a-pinned-reference-and-it-is-behind) | retracted | `0.84-0.94x` |
| [Decode's Gap Is Not Work: The Load Counts Are At Parity](#decodes-gap-is-not-work-the-load-counts-are-at-parity) | diagnostic | `199,211 loads, exact parity` |
| [Allocation Pressure In The Core, Independent Of Who Wins The Allocator](#allocation-pressure-in-the-core-independent-of-who-wins-the-allocator) | null | `57 -> 54 allocations` |
| [How Much Of Decode's Gap Is The Allocator: About Half, And All Of The Variance](#how-much-of-decodes-gap-is-the-allocator-about-half-and-all-of-the-variance) | diagnostic | `4.3-7.1%` |
| [Where Decode's Time Actually Is, And Two Symbols That Lie](#where-decodes-time-actually-is-and-two-symbols-that-lie) | diagnostic | `~15%` |
| [The Setup Nobody Had Split, Split](#the-setup-nobody-had-split-split) | landed | `-1.9%` |
| [Bytes, Not Count: What The C++ Allocator Actually Pays For](#bytes-not-count-what-the-c-allocator-actually-pays-for) | landed | `-4.6%` |
| [In-Place Prediction: The Values Buffer Folds Into The Corrections](#in-place-prediction-the-values-buffer-folds-into-the-corrections) | landed | `-8%` |
| [The dhat Round: Reserves Undershooting The Entropy Floor](#the-dhat-round-reserves-undershooting-the-entropy-floor) | landed | `-4 to -6%` |
| [Speed 0, Decomposed At Last](#speed-0-decomposed-at-last) | diagnostic | `~30 us` |
| [Callgrind, Both Sides: The Gap Is Connectivity, Not Attributes](#callgrind-both-sides-the-gap-is-connectivity-not-attributes) | landed | `-17%` |
| [The Release Profile Nobody Had Set](#the-release-profile-nobody-had-set) | landed | `1.04x -> 1.10x` |
| [The Raw Symbol Run, Decoded Against Hoisted Tables](#the-raw-symbol-run-decoded-against-hoisted-tables) | landed | `-37.5%` |
| [Encode, Split By Stage At Last -- And The Gap Is Quantization](#encode-split-by-stage-at-last-and-the-gap-is-quantization) | landed | `-8.1%` |
| [The Ribbon's Encode Excess, Accounted For -- Including Two Nulls](#the-ribbons-encode-excess-accounted-for-including-two-nulls) | landed | `-31%` |
| [The Work Only One Side Did](#the-work-only-one-side-did) | landed | `-2.0%` |
| [The Step That Was Rederived Every Face](#the-step-that-was-rederived-every-face) | landed | `-70%` |
| [One Table That Wanted A Push, And Three That Did Not](#one-table-that-wanted-a-push-and-three-that-did-not) | landed | `-21%` |
| [Reading The Decode By File, Which Inlining Cannot Merge Away](#reading-the-decode-by-file-which-inlining-cannot-merge-away) | landed | `-49%` |
| [Both Sides Read By File, And The libc Row Retires](#both-sides-read-by-file-and-the-libc-row-retires) | retracted | `666,275 vs 855,430 instructions` |
| [The Mapping Loop That Derived A Corner It Was Already Holding](#the-mapping-loop-that-derived-a-corner-it-was-already-holding) | landed | `-3.4%` |
| [A Face's Degeneracy, Asked Once Instead Of Nine Times](#a-faces-degeneracy-asked-once-instead-of-nine-times) | landed | `-5.8%` |
| [The Vertex Map's Reach, Without The Branch](#the-vertex-maps-reach-without-the-branch) | landed | `-1.3%` |
| [The KD-Tree Encode, Counted For The First Time](#the-kd-tree-encode-counted-for-the-first-time) | landed | `-22.8%` |
| [Three Nulls From The Same Session](#three-nulls-from-the-same-session) | rejected | `+5.5%` |
| [The Corner Asked For Twice](#the-corner-asked-for-twice) | landed | `-1.5%` |
| [What The Clock Said About All Of It](#what-the-clock-said-about-all-of-it) | diagnostic | `-7.0%` |
| [The Decode's Turn: Five Calls The Inliner Was Pricing Wrong](#the-decodes-turn-five-calls-the-inliner-was-pricing-wrong) | landed | `-14.5%` |
| [One Tex-Coord Predictor, And An Exact Wrap Reconstruction -- Both Flat](#one-tex-coord-predictor-and-an-exact-wrap-reconstruction-both-flat) | null | `+0.064%` |
| [One Owner For The Parents, And Their Copies -- Encode Flat](#one-owner-for-the-parents-and-their-copies-encode-flat) | null | `+0.19%` |
| [The Encoder Binds By Version Too -- And Still Flat](#the-encoder-binds-by-version-too-and-still-flat) | null | `+0.58%` |
| [The Portable Parent, Made Structural -- And Measured Flat](#the-portable-parent-made-structural-and-measured-flat) | null | `-0.086%` |
| [The Small-Mesh Encode Cost, Reproduced Against Its Own Hypothesis](#the-small-mesh-encode-cost-reproduced-against-its-own-hypothesis) | retracted | `3.6%` |
| [The Per-Call Floor, Named In Full -- And Reuse Buys None Of It](#the-per-call-floor-named-in-full-and-reuse-buys-none-of-it) | diagnostic | `84 allocations` |
| [The Options Clone, Made -- As A Counted Change](#the-options-clone-made-as-a-counted-change) | landed | `84 -> 79 allocations` |
...
**Superseded, and not comparable with anything else here.** The tables in this
section measure against the patched C++ checkout, so every C++ figure in them
carries the `4.8x` encode factor described in `PERFORMANCE.md`. They are kept
because several later rounds quote them as their starting point, not because
they describe either implementation.
...
In the order they were run, oldest first. Each names what it measured against;
where a round's C++ side is the patched checkout, its ratios are not comparable
with a pristine-build figure.
...
What that moved on the Bunny table `PERFORMANCE.md` carries: against the
2026-08-18 figures it replaced, position-only went from `0.70x`/`0.69x` to
`0.78x`/`0.76x` at speeds 5 and 9, and the normal-carrying mesh from
`0.97x`/`0.86x` to `1.01x`/`0.93x` at the same speeds -- consistent with the
`11-13%` and `2.7-2.9%` the two payloads showed in this round's interleaved
A/B, which is a different tool measuring the same change and landing on the
same number twice.

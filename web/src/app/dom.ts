...
export const fbxCompressionLevelRow = element('fbx-compression-level-row');
export const fbxCompressionLevel = element<HTMLInputElement>('fbx-compression-level');
...
export const viewerVariantTrigger = element<HTMLButtonElement>('viewer-variant-trigger');
export const viewerVariantLabel = element('viewer-variant-label');
export const viewerVariantMenu = element('viewer-variant-menu');
export const fileModelPicker = element('file-model-picker');
export const fileModelCaption = element('file-model-caption');
export const fileModelSelect = element('file-model') as HTMLSelectElement;
export const fileModelTrigger = element<HTMLButtonElement>('file-model-trigger');
export const fileModelLabel = element('file-model-label');
export const fileModelMenu = element('file-model-menu');
